...
Then we introduce two help variables, **lopnr** and **antrec**. They will help us keeping track of where in an individual's records we presently are, especially if we are at the first or last record. The function **rc** in the package **skum* help us with that.
```{r recnum}
library(skum)
...
summary(fit)
plot(survfit(fit), mark.time = FALSE, xlab = "Age", xlim = c(15, 50))
```
